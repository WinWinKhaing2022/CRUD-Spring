...
<%
    ...
    <div id="sub_content" style="color:black;">
        ...
        <form:form action="/StudentRegister_Spring/addstudent" method="post" modelAttribute="sbean">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <form:input type="date" class="form-control" id="dob" path="dob" value="${data.dob}"/>
                </div>
            </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <form:input type="text" class="form-control" id="phone" value="${empty data.phone ? '+95' :data.phone} " path="phone" />
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
									...
									<c:forEach var="course" items="${courseList}">
										<div class="form-check-inline col-md-2">
											<input class="form-check-input" type="checkbox"
												${data.attendCourses.contains(course.id) ? 'checked' : ''}
												name="attendCourses" id="gridRadios1" value="${course.id}">
